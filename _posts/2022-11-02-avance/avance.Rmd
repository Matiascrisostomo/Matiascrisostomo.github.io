...
![Figure n°. Dynamic effects of global warming (3∘C) on global GDP (% change/year). Source: Kompas et al., 2018.](/Final Project/Dynamic impacts of global warming (3°C) om global GDP (%change/year).png)
...
![Figure n° .Countries GDP histogram](/UC/Primer año/Medición y análisis dimensional de datos políticos/Final Project/Histograma GDP.PNG)

![Figure n° .Countries Governance readiness histogram](/Escritorio/UC/Primer año/Medición y análisis dimensional de datos políticos/Final Project/Histograma Governance.PNG)

 
![Figure n°. Climate change vulnerability histogram](/Escritorio/UC/Primer año/Medición y análisis dimensional de datos políticos/Final Project/Histogram Vulnerability.PNG)


![Figure n°. Scaterrplot Model 1 (GDP-Governance)](/Escritorio/UC/Primer año/Medición y análisis dimensional de datos políticos/Final Project/Rplot Governance-GDP.PNG)
...
![Figure n°. Scatterplot Model 2 (Climate change vulnerability – GDP).)](/Escritorio/UC/Primer año/Medición y análisis dimensional de datos políticos/Final Project/Rplot CC Vulnerability-GDP.PNG)
...
![Figure n° Residuals vs fitted values plot (homocedasticity) in model 3 (GDP, governance and vulnerability).](/Escritorio/UC/Primer año/Medición y análisis dimensional de datos políticos/Final Project/Rplot Residual modelo 3.PNG) 
...
![Figure n°. Residual vs fitted values plot for lm(GDP~1+governance+ vulnerability)](/Escritorio/UC/Primer año/Medición y análisis dimensional de datos políticos/Final Project/Rplot Residual vs fitted.PNG) 
